...
router.get('/adresse/all', auth, addCtrl.get);
router.post('/adresse/new', auth, addCtrl.add);
router.put('/adresse/update', auth, addCtrl.update);

router.get('/certification/all', auth, certifCtrl.get);
...
router.get('/experience/all', auth, experienceCtrl.get);
...
router.get('/formation/all', auth, formationCtrl.get);
...
router.get('/skill/all', auth, skillCtrl.get);
